  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      ...
      it "re-renders the 'new' template" do
        Project.stub(:create) { mock_project(:save => false, :errors => { :anything => "any value (even nil)" }) }
        post :create, :project => {}
  ...
  describe "PUT update" do
    ...
    describe "with invalid params" do
      ...
      it "re-renders the 'edit' template" do
        Project.stub(:find) { mock_project(:update_attributes => false, :errors => { :anything => "any value (even nil)" }) }
        put :update, :id => "1"
